...
function ButtonInner({
  ...
  return (
    <>
      <span className="absolute inset-0 rounded-md bg-gradient-to-b from-white/80 to-white opacity-10 transition-opacity group-hover:opacity-25" />
...
export function Button({
  ...
  className = clsx(
    className,
    'uniform-size group relative isolate flex-none border-2 rounded-md py-0.5 text-[0.8125rem]/6 font-semibold font-nunito',
