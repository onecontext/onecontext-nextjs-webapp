...
const AUGMENTED_CONTEXT_LIMIT: number = Number(process.env.AUGMENTED_CONTEXT_LIMIT!)
...
// See the template page to see how the entire app is wrapped in the AI state. 
