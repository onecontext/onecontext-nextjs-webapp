...
## Is this Provider available on the client or the server side?
...
This file defines the `AI Provider` object and (importantly) the `contextChat` method which lives as an `action` on the AI state.

## `AI State` Object
The `AI State`, confusingly, is 
